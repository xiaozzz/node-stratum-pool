...
var BlockTemplate = module.exports = function BlockTemplate(
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            ...
            // Reserved for PBaaS future use
            if (this.rpcData.solution !== undefined) {
                // append VERUS_SOLUTION_VER as 9th job param
                // Resereved for PBaaS future compressed header solution
                this.jobParams.push(3);
            }
        }
